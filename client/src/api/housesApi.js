...
export const getHouse = async (houseId) => {
  try {
    const response = await axios.get(`http://localhost:3000/api/houses/${houseId}`)
    return response.data
  } catch (e) {
    console.error(e);
  }
...
export const getHouseImages = async (houseId) => {
  try {
    const response = await axios.get(`http://localhost:3000/api/house/${houseId}/pictures`)
    return response.data
  } catch (e) {
    console.error(e);
  }
...
export const getHousesOneImage = async (houseId, imageId) => {
  try {
    const response = await axios.get(`http://localhost:3000/api/house/${houseId}/pictures/${imageId}`)
    return response.data
  } catch (e) {
    console.error(e);
  }
...
export const deleteHousePicture = async (houseId, imageId) => {
  try {
    await axios.delete(`http://localhost:3000/api/house/${houseId}/pictures/${imageId}`)
